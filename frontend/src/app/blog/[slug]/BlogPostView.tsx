...
interface BlogPostViewProps {
  post: BlogPost;
  cluster: AuthorityCluster | null;
  clusterPosts: BlogPost[];
}

export const BlogPostView: React.FC<BlogPostViewProps> = ({ post, cluster, clusterPosts }) => {
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <main className="lg:col-span-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            {post.technicalSegments && Object.keys(post.technicalSegments).length > 0 && (
            ...
            {post.githubRepo && post.githubRepo.owner && (
