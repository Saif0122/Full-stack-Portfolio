...
export default function Error({
  ...
  return (
    <div className="pt-48 pb-24 min-h-screen bg-background flex flex-col items-center justify-center text-center px-6">
      ...
      <h2 className="text-3xl font-black text-white mb-4 tracking-tight">Transmission Failed</h2>
      <p className="text-gray-400 font-light text-lg mb-10 max-w-md">
        Unable to connect to the CMS database. The node may be undergoing maintenance.
      </p>
      <button
        onClick={() => reset()}
